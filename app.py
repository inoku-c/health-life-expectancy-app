...
fig_bar.update_layout(
    ...
    xaxis=dict(
        ...
        zerolinewidth=2,
        gridcolor="#edf2f7",
        titlefont=dict(family="Noto Sans JP"),
    ),
...
fig_age.add_hline(y=84, line_dash="dash", line_color="#a0aec0",
                   ...
                   annotation_font=dict(size=11, color="#718096", family="Noto Sans JP"))
fig_age.update_layout(
    height=350,
    margin=dict(t=30, b=40, l=50, r=30),
    paper_bgcolor="rgba(0,0,0,0)",
    plot_bgcolor="rgba(0,0,0,0)",
    xaxis=dict(title="入力年齢（歳）", gridcolor="#edf2f7",
               titlefont=dict(family="Noto Sans JP"),
               tickfont=dict(family="Noto Sans JP")),
    yaxis=dict(title="推定寿命（歳）", gridcolor="#edf2f7", range=[50, 105],
               titlefont=dict(family="Noto Sans JP"),
               tickfont=dict(family="Noto Sans JP")),
    font={"family": "Noto Sans JP"},
